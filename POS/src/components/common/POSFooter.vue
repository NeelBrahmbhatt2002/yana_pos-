...
const linkText = ref("YANAERP");
const footerLink = ref("https://apps.yanaerp.com");
...
const brandSignature = computed(() => `YANAERP-${componentId}`);
...
const loadBrandingConfig = async () => {
	try {
		...
		footerText.value = "Powered by";
		linkText.value = "YANAERP";
		footerLink.value = "https://apps.yanaerp.com";
	}
};
...
const ensureBranding = () => {
	...
	const expectedBrand = atob(btoa("YanaERP"));
	const expectedUrl = atob(btoa("https://apps.yanaerp.com"));
	const expectedText = atob(btoa("Powered by"));
